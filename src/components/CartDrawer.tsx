        ...
        <>
          ...
          >
            <div className="flex items-center justify-between px-6 py-6 border-b hairline">
              ...
              <button type="button" onClick={close} aria-label="Close bag" className="p-1 text-bone hover:text-brass-soft transition-colors">
            ...
            {lines.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center gap-6 px-8 text-center">
                <p className="text-ash leading-7">Your bag is empty. The pieces are waiting.</p>
              ...
              <>
                      ...
                      <div className="flex-1">
                        <div className="flex items-baseline justify-between gap-3">
                          ...
                          <button
                            ...
                            aria-label={`Remove ${l.title} from bag`}
                ...
                <div className="border-t hairline px-6 py-6">
                  ...
                  <p className="text-xs text-ash mb-6">Shipping and delivery timing are confirmed over WhatsApp.</p>
                  <a
                    href={checkoutHref}
                    target="_blank"
